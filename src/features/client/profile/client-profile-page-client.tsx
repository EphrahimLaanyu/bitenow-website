  ...
  if (status === "unauthenticated" && !getAccessToken()) {
    return (
      <div className="space-y-6">
        <ProfileHeader />
        <Card className="guest-page-hero hero-surface food-spotlight border-none">
  ...
  return (
    <div className="space-y-7">
      ...
      <section className="grid gap-5 lg:grid-cols-[1fr_22rem]">
        <Card className="rounded-[1.5rem] border-[var(--border)] shadow-[0_14px_34px_rgba(16,31,63,0.07)]">
...
function ProfileHeader() {
  return (
    <div className="guest-page-hero hero-surface food-spotlight p-6 md:p-8">
      <Badge>Profile</Badge>
      <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-[var(--foreground)] md:text-5xl">
